...
## developing
do `npm i qrboy -g` (make sure npm is instaled!) from the project directory. now you can compile programs from sembly, my own assembly-like language, using `qrcode-sembly`.
